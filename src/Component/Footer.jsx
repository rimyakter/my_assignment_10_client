      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="mb-2">Email: info@roommatefinder.com</p>
            <p className="mb-2">Phone: +8801871494520</p>
            <p className="mb-2">Address: Sector:05, Road:05, Uttara, Dhaka</p>
          </div>
        ...
        <div className="mt-10 text-center text-sm text-white">
          &copy; {new Date().getFullYear()} Roommate Finder. All rights
          reserved.
        </div>
      </div>
    </footer>
